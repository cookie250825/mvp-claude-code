...
## v1.6.4 — 代码审查 + 简历素材整理 (2026-05-29)

### 文档
- **MVP_项目亮点_简历素材.md** — 新增完整简历素材文档，含 12 个核心亮点、量化数据、5 个面试权衡问答、3 版简历描述模板
- **README.md** — 新增"面试问题与标准回答"专区（12 题），涵盖架构设计、安全、性能、扩展性全维度
- **README.md** — 新增"已知限制与改进计划"章节，包含 P0/P1/P2 三级优先级分类

### 审查结论
- 完成度评估：85%，与 Claude Code 核心架构相似度 70%
- 代码可读性 9/10，架构设计 9/10，安全性 8.5/10，测试覆盖 3/10
- P0 问题：MCPClient 单行 JSON 限制、Config 无早期校验、无 graceful shutdown
